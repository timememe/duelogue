...
const PROFILES := [
	...
	},
	{
		...
		"links": {"wobble_x": 0, "wobble_y": 0, "crowd_ko": 0, "crowd_hold": 1},
	...
	{
		"id": "vector_gate",
		"label": "Вектор + шатание 2/4",
		"description": "Доска решает; strain 2/3/4 владельца открывает захват его рамок толщины 2/3/4.",
		"board": {"frame_weight": 3, "thesis_weight": 1},
		"audience": CONDUCT_AUDIENCE,
		"links": {"wobble_x": 2, "wobble_y": 4, "crowd_ko": 0, "crowd_hold": 1},
		"terminal": {"board_ko": false},
		"victory": {"mode": "board", "audience_weight": 0},
	},
	{
	...
	},
	{
		...
		"links": {"wobble_x": 2, "wobble_y": 4, "crowd_ko": 10, "crowd_hold": 3},
		"terminal": {"board_ko": true},
